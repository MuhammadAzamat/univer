               ...
               <Row>
                  <Col span={18} className="person_info-block">
                     ...
                     <Row className="person_info-row">
                        ...
                        <Col className="person_info-col" span={8}>
                           <p className="person_info-title">Nogironlik boyicha eslatma</p>
                  ...
                  <Col span={6}>
                     ...
                     <img style={{ width: "150px" }} src="/person-photo.png" alt="person photo" />
                  </Col>
               </Row>
            </div>
            <div className="person_info">
               ...
               <Row>
                  ...
                  <Col span={6}>
                     <div>
                        ...
                        <img style={{ width: "200px", display: "block", marginBottom: "12px" }} src="/password1.png" alt="person photo" />
                        <img style={{ width: "200px", display: "block" }} src="/password2.png" alt="person photo" />
                     </div>
                  </Col>
               </Row>
            </div>
            <div className="person_info">
               ...
               <Row>
                  <Col className="person_info-block" span={18}>
                     <Row className="person_info-row">
                        <Col className="person_info-col" span={8}>
                           <p className="person_info-title">Majburiy 11 yillik ta’lim turi</p>
                  ...
                  <Col span={6}>
                     <div className="person_info-photo_information">
                        ...
                        <img style={{ width: "200px", display: "block" }} src="/diplom.png" alt="person photo" />
                        <span className="">
                           Yana <br />
                           +2 ta rasm
                        </span>
            ...
            <div className="person_info">
               ...
               <Row>
                  ...
                  <Col span={6}>
                     ...
                     <img style={{ width: "200px" }} src="/sertifikat.png" alt="person photo" />
                  </Col>
               </Row>
            </div>
